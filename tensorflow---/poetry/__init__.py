...
poetry_file = '/Users/zuobangbang/Desktop/poetry.txt'
        ...
        with tf.device('/gpu:2'):
            ...
            for epoch in range( 110):
                ...
                for batche in range(n_chunk):
                    ...
                    # train_loss, _, _,logits,probs = sess.run([cost, last_state, train_op,logits,probs],
                    #                             feed_dict={input_data: x, output_targets: y})
                    train_loss, _, _,lr = sess.run([cost, last_state, train_op,learning_rate],
                                                               feed_dict={input_data: x, output_targets: y})
                    # print(logits)
                    # print(train_loss)
                    # print(logits.shape)
                    ...
                    if batche % 50 == 1:
                        ...
                        print(epoch, batche, 0.002 * (0.97 ** epoch), train_loss,lr)
